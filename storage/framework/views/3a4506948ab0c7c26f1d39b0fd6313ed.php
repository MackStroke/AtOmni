            ...
            <div class="flex-1">
                ...
                <div class="flex items-center gap-4 mb-6">
                    <div class="w-12 h-12 bg-gradient-to-br from-electric to-cyan-glow text-white font-bold text-lg rounded-full flex items-center justify-center shrink-0 shadow-lg shadow-electric/30">
                        <?php echo e(substr(\App\Models\Setting::get('site_name', 'Atomni'), 0, 1)); ?>
                ...
                <div class="flex flex-col gap-3 w-full max-w-md">
                    ...
                    ?>
                    <a href="<?php echo e($donateLink); ?>" onclick="dismissAdblockModal();"
...
<?php /**PATH D:\xampp\htdocs\atomni-pro\resources\views/partials/adblock-modal.blade.php ENDPATH**/ ?>