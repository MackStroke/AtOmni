<?php $__env->startSection('title', 'Login - Atomni'); ?>
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-navy-900 flex-col items-center justify-center relative overflow-hidden border-r border-navy-800">
        ...
        <div class="relative z-10 text-center flex flex-col items-center px-12">
            ...
            <?php if($logoLight && $logoDark): ?>
                <img loading="lazy" src="<?php echo e(\Illuminate\Support\Facades\Storage::url($logoLight)); ?>" alt="<?php echo e($siteName); ?>" class="h-10 mb-8 drop-shadow-2xl logo-light">
                <img loading="lazy" src="<?php echo e(\Illuminate\Support\Facades\Storage::url($logoDark)); ?>" alt="<?php echo e($siteName); ?>" class="h-10 mb-8 drop-shadow-2xl logo-dark">
            <?php elseif($logoLight): ?>
                <img loading="lazy" src="<?php echo e(\Illuminate\Support\Facades\Storage::url($logoLight)); ?>" alt="<?php echo e($siteName); ?>" class="h-10 mb-8 drop-shadow-2xl">
            <?php elseif($logoDark): ?>
                <img loading="lazy" src="<?php echo e(\Illuminate\Support\Facades\Storage::url($logoDark)); ?>" alt="<?php echo e($siteName); ?>" class="h-10 mb-8 drop-shadow-2xl">
            <?php else: ?>
                <img loading="lazy" src="<?php echo e(asset('images/atomni-logo-light.svg')); ?>" alt="<?php echo e($siteName); ?>" class="h-10 mb-8 drop-shadow-2xl logo-light">
                <img loading="lazy" src="<?php echo e(asset('images/atomni-logo-dark.svg')); ?>" alt="<?php echo e($siteName); ?>" class="h-10 mb-8 drop-shadow-2xl logo-dark">
            <?php endif; ?>
            
            <p class="text-lg text-text-muted max-w-md leading-relaxed font-medium">
                <?php echo e(\App\Models\Setting::get('website_tagline', 'Your premier source for breaking news, in-depth analysis, and trending stories.')); ?>
        ...
        <div class="w-full max-w-md p-8 sm:p-10 space-y-8 glass-card border border-navy-800/60 rounded-3xl shadow-2xl relative z-10">
            <div class="text-center">
                ...
                <div class="lg:hidden flex justify-center mb-6">
                    <?php if($logoLight || $logoDark): ?>
                        <?php if($logoLight): ?>
                            <img loading="lazy" src="<?php echo e(\Illuminate\Support\Facades\Storage::url($logoLight)); ?>" alt="<?php echo e($siteName); ?>" class="h-12 drop-shadow-xl logo-light">
                        <?php endif; ?>
                        <?php if($logoDark): ?>
                            <img loading="lazy" src="<?php echo e(\Illuminate\Support\Facades\Storage::url($logoDark)); ?>" alt="<?php echo e($siteName); ?>" class="h-12 drop-shadow-xl logo-dark">
                        <?php endif; ?>
                    <?php else: ?>
                        <img loading="lazy" src="<?php echo e(asset('images/atomni-logo-light.svg')); ?>" alt="<?php echo e($siteName); ?>" class="h-12 drop-shadow-xl logo-light">
                        <img loading="lazy" src="<?php echo e(asset('images/atomni-logo-dark.svg')); ?>" alt="<?php echo e($siteName); ?>" class="h-12 drop-shadow-xl logo-dark">
                    <?php endif; ?>
                </div>
            ...
            <form class="mt-8 space-y-6" action="<?php echo e(route('login.submit')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="<?php echo e(route('password.request')); ?>" class="font-bold text-accent-blue hover:text-accent-blue-hover transition-colors">
                            Forgot password?
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\atomni-pro\resources\views/auth/login.blade.php ENDPATH**/ ?>