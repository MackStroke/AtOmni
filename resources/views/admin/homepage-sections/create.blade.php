...
<div class="max-w-3xl mx-auto">
    <div class="page-header mb-6 flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-bold text-text-primary">Add New Section</h1>
        </div>
    </div>
    ...
    <div class="glass-card rounded-2xl p-6 md:p-8">
        <form action="{{ route('admin.homepage-sections.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" required class="w-full px-4 py-2.5 bg-navy-900 border border-navy-700 rounded-xl text-text-primary focus:ring-2 focus:ring-electric focus:border-transparent transition-all">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="post_limit" id="post_limit" value="{{ old('post_limit', 6) }}" min="1" max="20" required class="w-full px-4 py-2.5 bg-navy-900 border border-navy-700 rounded-xl text-text-primary focus:ring-2 focus:ring-electric focus:border-transparent transition-all">
                ...
                <div>
                    ...
                    <input type="number" name="order" id="order" value="{{ old('order', 0) }}" class="w-full px-4 py-2.5 bg-navy-900 border border-navy-700 rounded-xl text-text-primary focus:ring-2 focus:ring-electric focus:border-transparent transition-all">
