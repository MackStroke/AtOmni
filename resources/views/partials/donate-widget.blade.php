@php $qrLink = \App\Models\Setting::get('donate_qr_link', ''); @endphp
...
<div class="glass-card rounded-2xl p-5 border border-navy-700/20 text-center">
    ...
    <a href="{{ url('/donate') }}" class="block w-full py-2.5 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-electric to-cyan-glow hover:from-electric-light hover:to-cyan-glow transition-all shadow-lg shadow-electric/20 hover:shadow-electric/40 hover:-translate-y-0.5">
        Contribute Now →
    </a>
